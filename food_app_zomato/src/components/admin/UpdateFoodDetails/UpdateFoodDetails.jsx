    ...
    renderUpdateModel() {
        return (
            <div className="update_container">
                ...
                <button onClick={()=>this.updateFoodDetails()} >update</button><button onClick={() => this.setState({ show: false })}>close</button>
            </div>
        )
    }

    updateFoodDetails(updateFDID){
        this.props.updateFoodDetails(updateFDID)
